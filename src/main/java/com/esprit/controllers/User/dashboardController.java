...
import com.esprit.controllers.Document.AfficherDocuments;
import com.esprit.controllers.Document.documentsUser;
import com.esprit.controllers.Traffic.DisplayIntersections;
import com.esprit.controllers.Transport.ConsulterLigneTransport;
...
public class dashboardController {
    ...
    private void navigateToTraffic() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/gestion_traffic.fxml"));
            Parent root = loader.load();
            DisplayIntersections controller = loader.getController();
            controller.initData(connectedUser, userProfile);

            Stage stage = (Stage) GoToTraffic.getScene().getWindow();
            stage.setScene(new Scene(root));
            stage.show();
            updateUI();
        } catch (Exception e) {
    ...
    private void navigateToDocument() {
        try {
            ...
            Stage stage = (Stage) GoToMunicipality.getScene().getWindow();
            stage.setScene(new Scene(root));
            stage.show();
            updateUI();
        } catch (Exception e) {
