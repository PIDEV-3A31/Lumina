...
public class ConsulterLigneTransport {
    ...
    private void handleAddLigne() {
        try {
            ...
            Parent root = loader.load();
            AjouterLigneTransport controller = loader.getController();
            controller.initData(connectedUser, userProfile);
    ...
    private void handleAddMoyen() {
        try {
            ...
            Parent root = loader.load();
            AjouterMoyenTransport controller = loader.getController();
            controller.initData(connectedUser, userProfile);
    ...
    private void handleReservation() {
        try {
            ...
            Parent root = loader.load();
            ReservationAdmin controller = loader.getController();
            controller.initData(connectedUser, userProfile);


            Stage currentStage = (Stage) conculter_reservation.getScene().getWindow();
            Scene newScene = new Scene(root);
            currentStage.setScene(newScene);
        } catch (IOException e) {
            e.printStackTrace();
