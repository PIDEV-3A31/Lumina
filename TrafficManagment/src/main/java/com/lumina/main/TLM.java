...
public class TLM {
    ...
    public static void main(String[] args) {
        ...
        intersection.setId(31);  // Assuming this ID is retrieved or set for testing purposes
        ...
        trafficLight.setNumberOfCars(25);  // Update the number of cars for the traffic light
